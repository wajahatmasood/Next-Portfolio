    ...
    <AppLayout title="Work Detail">
      <div className="container">
        ...
        <div className="my-10">
          ...
          <h3 className="mt-10 text-xl font-semibold">Key Insights</h3>
        ...
        <div className="mb-10 flex h-48 flex-col items-center justify-center">
          <h2 className="text-4xl font-semibold">Want me to test your project?</h2>
          <p className="mt-4">I can test and manage projects for you</p>
          <Link href="/contact">
